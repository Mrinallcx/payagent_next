  ...
  return (
    <div className="min-h-screen bg-white font-landing landing-grid-bg">
      <div className="max-w-[680px] mx-auto px-6 relative z-[1]">
        ...
        {/* ── HEADER ── */}
        <MobileNav links={NAV_LINKS} className="pt-6 animate-fade-up">
          ...
          <nav className="hidden sm:flex items-center">
            <Link href="/about" className="text-sm font-semibold text-gray-500 hover:text-blue-600 transition-colors ml-5">About</Link>
        ...
        <section className="pt-11 animate-fade-up flex flex-col">
          <h1 className="text-[clamp(28px,5.5vw,40px)] font-bold leading-[1.15] tracking-tight text-slate-900 mb-4">
            Instant Crypto Payments<br />for Humans and AI&nbsp;Agents
          </h1>
          <p className="text-[17px] leading-relaxed text-gray-500 mb-6">
            Send, receive, and automate instant crypto payments with low fees
          </p>
          ...
          <div className="rounded-[14px] p-5 bg-blue-50 border border-blue-200 mb-6 sm:hidden">
            ...
            <p className="text-sm leading-relaxed text-gray-700 mb-4">
              Instant payments directly from your wallet. Low fees, non-custodial, full control.
            </p>
            <WalletCTA />
          </div>
          ...
          <div className="bg-slate-50 border border-slate-200 rounded-[10px] px-5 py-4 text-base font-medium text-gray-700 mb-6 leading-relaxed">
            AI agents are becoming economic actors. PayAgent is how they make instant payments.
          </div>

          <div className="bg-blue-50 border border-blue-200 rounded-[14px] px-6 py-7 max-sm:px-4 max-sm:py-5 mb-7 text-center">
            <div className="text-xs font-bold text-blue-600 uppercase tracking-[1px] mb-5 max-sm:mb-3">Live autonomous payment flow</div>
            <div className="flex items-center justify-center gap-4 max-sm:gap-2 mb-3.5 max-sm:mb-2">
              <div className="flex items-center gap-2 max-sm:gap-1 text-base max-sm:text-sm font-bold text-slate-900"><span className="text-2xl max-sm:text-lg">🤖</span> Agent&nbsp;A</div>
              <div className="flex items-center gap-0.5 text-blue-600"><span className="tracking-[3px] max-sm:tracking-[1px] font-mono text-sm max-sm:text-xs">......</span><span className="text-lg max-sm:text-base font-bold">→</span></div>
              <div className="flex items-center gap-2 max-sm:gap-1 text-base max-sm:text-sm font-bold text-slate-900">Agent&nbsp;B <span className="text-2xl max-sm:text-lg">🤖</span></div>
            </div>
            <div className="flex justify-center gap-12 max-sm:gap-6 text-[13px] max-sm:text-[12px] text-gray-500 mb-4 max-sm:mb-2.5">
              <span>request payment</span><span>settled automatically</span>
            </div>
            <div className="text-sm font-semibold text-slate-900">No humans. No custody. No manual steps.</div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3.5 mb-12 max-[520px]:grid-cols-1">
            <div className="rounded-[14px] p-5 bg-blue-50 border border-blue-200 max-sm:hidden">
              <div className="flex items-center gap-2 mb-2.5"><span className="text-xl">💼</span><h3 className="text-[17px] font-bold text-slate-900">For Humans</h3></div>
              <p className="text-sm leading-relaxed text-gray-700 mb-4">Instant payments directly from your wallet. Low fees, non-custodial, full control.</p>
              <WalletCTA />
            </div>
            <div className="rounded-[14px] p-5 bg-blue-50/60 border border-blue-200">
              <div className="flex items-center gap-2 mb-2.5"><span className="text-xl">🤖</span><h3 className="text-[17px] font-bold text-slate-900">For AI Agents</h3></div>
              <p className="text-sm leading-relaxed text-gray-700 mb-4">Autonomous software that earns, spends, and settles value via the AI agent payment API.</p>
              <Link href="/docs" className="inline-block px-5 py-2.5 rounded-lg text-sm font-bold text-white bg-blue-600 hover:bg-blue-700 transition-all hover:-translate-y-px">Explore AI Payments →</Link>
            </div>
          </div>
        </section>
        ...
        <ScrollReveal>
          <section className="py-12 border-t border-slate-200">
            ...
            <p className="text-base text-gray-500 mb-8 leading-relaxed">Every paid link rewards the creator with LCX tokens. Humans and AI agents earn the same way.</p>
        ...
        <ScrollReveal>
          <section className="py-12 border-t border-slate-200">
            ...
            <p className="text-base text-gray-500 mb-8 leading-relaxed">No percentages. No hidden costs. Flat LCX token fees paid by the payer.</p>
            <div className="w-full border border-slate-200 rounded-xl overflow-hidden mb-3">
              <table className="w-full border-collapse">
                <thead><tr className="bg-slate-900 text-white"><th className="text-[11px] font-bold uppercase tracking-[1px] px-4 py-3 text-left">Mode</th><th className="text-[11px] font-bold uppercase tracking-[1px] px-4 py-3 text-left">Fee</th><th className="text-[11px] font-bold uppercase tracking-[1px] px-4 py-3 text-left">Creator Reward</th><th className="text-[11px] font-bold uppercase tracking-[1px] px-4 py-3 text-left">Assets</th></tr></thead>
                <tbody>
                  <tr className="border-b border-slate-100"><td className="px-4 py-3 text-sm text-gray-700 font-semibold">Standard</td><td className="px-4 py-3 text-sm text-gray-700">2 LCX</td><td className="px-4 py-3 text-sm text-gray-700">1 LCX</td><td className="px-4 py-3 text-sm text-gray-700">USDC, USDT, USAT</td></tr>
                  <tr className="bg-slate-50"><td className="px-4 py-3 text-sm text-gray-700 font-semibold">Pro</td><td className="px-4 py-3 text-sm text-gray-700">4 LCX</td><td className="px-4 py-3 text-sm text-gray-700">2 LCX</td><td className="px-4 py-3 text-sm text-gray-700">Any ERC-20</td></tr>
                </tbody>
              </table>
            </div>
            <p className="text-[13px] text-gray-400 leading-relaxed">If the payer does not hold LCX, the required amount is auto-sourced via Uniswap. Payments never fail due to missing tokens. Standard Ethereum gas fees also apply.</p>
          </section>
        </ScrollReveal>
        ...
        <ScrollReveal>
          <section className="py-12 border-t border-slate-200">
            ...
            <h2 className="text-[26px] font-bold tracking-tight mb-2">How It Works — Create a payment link in seconds</h2>
            <p className="text-base text-gray-500 mb-8 leading-relaxed">Free to create. No signup required. Connect your wallet and go.</p>
            <div className="max-w-[540px]">
              {[
                ...
                <div key={step.num} className={`flex gap-4 mb-6 relative ${i < arr.length - 1 ? "step-connector" : ""}`}>
                  <div className="w-[34px] h-[34px] rounded-full bg-blue-600 text-white font-mono text-sm font-bold flex items-center justify-center shrink-0">{step.num}</div>
                  <div><h4 className="text-[15px] font-bold text-slate-900 mb-0.5">{step.title}</h4><p className="text-sm text-gray-500 leading-relaxed">{step.desc}</p></div>
                </div>
              ))}
            </div>
          </section>
        ...
        <ScrollReveal>
          <section className="py-12 border-t border-slate-200">
            ...
            <p className="text-base text-gray-500 mb-8 leading-relaxed">Real-time transaction monitoring for every link you create.</p>
            ...
            <p className="text-center text-[13px] text-gray-400 mt-5 italic">Full payment history with filtering, export, and analytics coming soon.</p>
          </section>
        </ScrollReveal>
        ...
        <ScrollReveal>
          <section className="py-12 border-t border-slate-200">
            <div className="text-xs font-bold uppercase tracking-[1.2px] text-blue-600 mb-2">For AI Agents</div>
            <h2 className="text-[26px] font-bold tracking-tight mb-2">Built for Scale — AI Agent Infrastructure</h2>
            <p className="text-base text-gray-500 mb-8 leading-relaxed">Non-custodial payment infrastructure for humans and autonomous software.</p>
            <div className="grid grid-cols-3 gap-3.5 max-[580px]:grid-cols-1">
              {[
                ...
                <div key={f.title} className="bg-slate-50 border border-slate-200 rounded-xl py-6 px-4 text-center">
                  <div className="w-11 h-11 rounded-[10px] bg-blue-50 inline-flex items-center justify-center text-xl mb-3">{f.icon}</div>
        ...
        <ScrollReveal>
          <section className="py-12 border-t border-slate-200">
            ...
            <p className="text-base text-gray-500 mb-8 leading-relaxed">Live on Ethereum. Expanding to all major L2s.</p>
            <div className="flex items-center justify-center gap-5 flex-wrap">
              {[
                ...
                <div key={n.name} className="flex items-center gap-2 text-sm font-semibold text-gray-700 px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-lg">
                  <span className={`w-2 h-2 rounded-full ${n.live ? "bg-emerald-600" : "bg-gray-300"}`} />{n.name}
                </div>
              ))}
            </div>
          </section>
        ...
        {/* ── BOTTOM CTA ── */}
        <ScrollReveal>
          <section className="py-14 border-t border-slate-200 text-center">
            <h2 className="text-[28px] font-bold tracking-tight mb-2">Start earning LCX today</h2>
            <p className="text-base text-gray-500 mb-6">Create your first payment link in under a minute. Free, non-custodial, instant.</p>
            <WalletCTA
            ...
            <div className="mt-4 text-sm">
              <Link href="/about" className="text-blue-600 font-semibold hover:underline mx-2.5">About</Link>
              <Link href="/changelog" className="text-blue-600 font-semibold hover:underline mx-2.5">Changelog</Link>
              <Link href="/docs" className="text-blue-600 font-semibold hover:underline mx-2.5">Documentation</Link>
            </div>
          </section>
        </ScrollReveal>
        ...
        <footer className="text-center py-8 border-t border-slate-200">
          ...
          <p className="text-[13px] text-gray-400 mt-2.5">
            ...
            {" · "}
            <Link href="/" className="text-blue-600 hover:underline">PayAgent</Link>
          </p>
        </footer>
