    ...
    <div className="min-h-screen bg-white font-landing landing-grid-bg">
      <div className="max-w-[720px] mx-auto px-6 relative z-[1]">
        ...
        <header className="pt-8 animate-fade-up">
          ...
          {mobileMenuOpen && (
            <nav className="sm:hidden mt-3 pb-3 border-b border-slate-200 flex flex-col gap-1">
              ...
              <span className="text-sm font-semibold text-blue-600 py-2 px-3 rounded-lg bg-blue-50">About</span>
        ...
        <article className="pb-12 animate-fade-up">
          ...
          {/* AI Agents Need Payment Infrastructure */}
          ...
          {/* LCX Token Fee and Reward Model */}
          ...
          <div className="space-y-2.5">
            {FAQ_ITEMS.map((item) => (
              <details key={item.q} className="group border border-slate-200 rounded-xl overflow-hidden">
                ...
                <div
                  className="px-5 pb-4 text-sm leading-[1.7] text-gray-500"
