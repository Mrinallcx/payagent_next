    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 pb-20">
        <div className="max-w-md w-full text-center space-y-6">
          <div className="text-[120px] font-heading font-bold text-blue-100 leading-none">
            404
          </div>
          ...
          <div className="space-y-2">
            ...
            <code className="text-xs text-muted-foreground bg-blue-50 border border-blue-100 px-3 py-1.5 rounded-md inline-block font-mono mt-2">
              {location.pathname}
            </code>
          </div>

          <div className="flex flex-col sm:flex-row gap-3 justify-center pt-4">
            <Button asChild className="bg-blue-600 hover:bg-blue-700 rounded-lg">
