            ...
            <div className="space-y-5">
              <div className="space-y-2">
                ...
                <div className="flex gap-2">
                  ...
                  />
                  {selectedToken && (
                    <div className="h-11 px-4 bg-blue-50 text-blue-700 rounded-lg flex items-center">
          ...
          {step === "network" && (
            <div className="space-y-5">
              <div className="bg-blue-50 rounded-lg p-3 flex items-center justify-between">
                ...
                <span className="font-semibold text-blue-700">{amount} {selectedToken}</span>
              </div>
                  ...
                  {[
                    ...
                    >
                      <Clock className={`h-5 w-5 mx-auto mb-2 ${
                        expiresInDays === option.value ? "text-blue-600" : "text-muted-foreground"
                      }`} />
            ...
            <div className="space-y-5">
              ...
              <div className="bg-blue-50 rounded-lg p-3">
                <div className="flex items-center gap-2">
                  <code className="flex-1 text-xs font-mono break-all bg-white rounded-md p-3 border border-blue-100">
                    {generatedLink}
                  </code>
                  <Button 
                    size="icon" 
                    variant="outline" 
                    onClick={handleCopy}
                    className="h-10 w-10 shrink-0 rounded-lg border-blue-200 hover:bg-blue-100"
                  >
              ...
              <Button onClick={handleCopy} className="w-full h-11 gap-2 rounded-lg bg-blue-600 hover:bg-blue-700">
                <Copy className="h-4 w-4" />
                Copy Link
              </Button>
            </div>
        ...
        {step !== "generated" && (
          <DialogFooter className="px-6 py-4 border-t border-border bg-slate-50/50">
            <div className="flex w-full gap-2">
              ...
              {step === "amount-token" && (
                <Button onClick={handleContinueToNetwork} className="gap-1 rounded-lg bg-blue-600 hover:bg-blue-700">
                  Continue
                  <ArrowRight className="h-4 w-4" />
                </Button>
              )}
              {step === "network" && (
                <Button onClick={handleContinueToExpiration} className="gap-1 rounded-lg bg-blue-600 hover:bg-blue-700">
                  Continue
                  <ArrowRight className="h-4 w-4" />
                </Button>
              )}
              {step === "expiration" && (
                <Button onClick={handleContinueToDetails} className="gap-1 rounded-lg bg-blue-600 hover:bg-blue-700">
                  Continue
                  <ArrowRight className="h-4 w-4" />
                </Button>
              )}
              {step === "details" && (
                <Button onClick={handleCreate} disabled={isLoading} className="gap-1 rounded-lg bg-blue-600 hover:bg-blue-700">
                  {isLoading ? (
                    <>
